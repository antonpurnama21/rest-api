...
$titleYT = $result['items'][0]['snippet']['localized']['title'];
$subCount = $result['items'][0]['statistics']['subscriberCount'];


$urlatestvideo = 'https://www.googleapis.com/youtube/v3/search?key=AIzaSyCTTsXAKTi3cA3rhSxMLrDoT1uwlPo5qKk&channelId=UCkXmLjEr95LVtGuIm3l2dPg&maxResults=1&order=date&part=snippet';
...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#home">Anton Purnama</a>
    ...
    <div class="jumbotron" id="home">
      <div class="container">
        <div class="text-center">
          ...
          <h1 class="display-4">Anton Purnama</h1>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">          
            <div class="col-md-5">
              <div class="row">
                <div class="col-md-4">
                  <img src="<?= $profilePIC ?>" width="100" class="rounded-circle img-thumbnail">
                </div>
                <div class="col-md-8">
                  <h5><?= $titleYT ?></h5>
